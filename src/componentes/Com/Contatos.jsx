  ...
  return (
    <section className="w-full bg-[#0d1324] text-white py-12 px-4" id="contatos">
      <div className="max-w-xl mx-auto text-center ">
        <h2 className="text-3xl font-roboto mb-4">Contatos</h2>
        <h3 className="text-2xl font-poppins mb-2 ">Gostou do meu trabalho?</h3>
        <p className="text-gray-300 mb-8 font-poppins">Entre em contato ou acompanhe as minhas redes sociais!</p>
        ...
        <div className="space-y-4">
          ...
          <ContactItem
            icon={<FaInstagram />}
            text="Instagram"
            link="https://www.instagram.com/annderson15/"
          />
          <ContactItem
            icon={<FaGithub />}
            text="GitHub"
        ...
        <p className="text-sm text-white mt-10 font-poppins">
          ©2025 Anderson De Jesus. Todos os direitos reservados.
        </p>
        <a href="#home" className=" flex flex-col ml-250">
        <FaArrowUp size={30}/>
        <span className="text-left text-2xl">Topo</span>
        </a>
