...
import Arquitetura from "../../assets/img/Imagens Projetos/Arqui.png";
...
function Projetos() {
  return (
    <section
      className="flex justify-center items-center flex-col bg-[#080F19]"
      id="projetos"
    >
      <h1 className="text-3xl m-4 text-white lg:text-4xl font-roboto">
        Projetos
      </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 justify-items-center m-5">
        ...
        <ProjetoCard
          ...
          image={Arquitetura}
          techs={["html", "css", "js"]}
          codeLink="https://github.com/WillMaac/Arquitetura-portf-lio"
          previewLink="https://arquitetura-portf-lio.vercel.app/"
        />
